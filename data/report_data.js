 ...
 */
export default {
  "source": "Milestone_Register_Sep20.xlsx",
  "milestones": [
    {
      "id": "AD-1-REG",
      ...
      "apmStageId": "APM1",
      "fsmStageId": "FSM1",
      "description": "A trusted, governed asset registry in Maximo Manage with unique asset records, defined asset and location hierarchies, and standardized asset information. Serves as the single source of truth for critical maintenance assets.",
      "valueStatement": "Enables work order linkage, job plan reuse, and downstream analytics. Without a clean asset register, health scoring and inspection scoping cannot be reliably performed.",
      "imperative": "Establish a governed, duplicate-free asset registry with defined naming conventions and location hierarchies.",
      "signals": [
        "Asset records created with consistent naming conventions",
      ...
      "touchpoints": [
        "Maximo Manage — Asset Registry & Location Hierarchy",
      ...
      "respMet": "Your asset register is a trusted, governed single source of truth — work order linkage, job plan reuse, and any analytics built on asset data are reliable because the foundation underneath them is clean and consistent. This positions you to build classification, hierarchy, and relationship structure on top of data you can trust.",
      "respUnmet": "consequence: Without a trusted, consistent asset register, work order linkage, job plan reuse, and any analytics built on asset data are unreliable — every capability above this one inherits whatever gaps exist here. \n\neffort: Achieving this requires establishing naming standards and a location-asset hierarchy for at least one critical asset class, eliminating duplicates, and putting a governance workflow in place to control ongoing record quality.",
      "respUnknown": "It's unclear whether a standardised asset register has been established in your environment. To clarify, speak with your System Administrator or Asset Manager — they will know whether a single source of truth for asset records exists and whether a governance workflow is in place for new asset creation."
    },
    {
      "id": "AD-1-CRIT",
      ...
      "apmStageId": "APM1",
      "fsmStageId": "FSM2",
      "description": "The organization's most critical assets are classified by criticality tier (Critical / High / Medium / Low) using a repeatable scoring methodology that is consistently applied across at least one critical asset class.",
      "valueStatement": "Directs maintenance effort and investment toward highest-impact assets. Ensures critical assets get appropriate scheduling priority. Prerequisite for FMEA prioritization and health scoring.",
      "imperative": "Classify all maintainable assets into defined criticality tiers using a repeatable scoring methodology.",
      "signals": [
        "Asset list segmented by criticality tier",
        "Criticality drives PM priority ranking in work management queue"
      ],
      "prerequisites": [
        "AD-1-REG"
      ],
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Priority Attribute on Asset Records",
      ...
      "respMet": "Maintenance effort is directed at your highest-impact assets rather than spread evenly across the population. This is the prerequisite that unlocks both FMEA prioritisation and health scoring — two capabilities that depend on knowing which assets matter most.",
      "respUnmet": "consequence: Without criticality scoring, maintenance effort and investment are spread evenly rather than directed at your highest-impact assets — and this is a prerequisite for FMEA prioritisation and health scoring, so skipping it blocks two later capabilities, not just this one. \n\neffort: Achieving this requires defining a repeatable scoring methodology, classifying all maintainable assets into criticality tiers, and configuring work order priority rules to reference those tiers in the scheduling queue.",
      "respUnknown": "It's unclear whether assets have been scored by criticality. Your Asset Manager or Reliability Engineer will know whether a criticality classification methodology is in use and whether it is actively driving maintenance prioritisation."
    },
    {
      "id": "AD-2-CLAS",
      ...
      "valueStatement": "Standardized maintenance approaches; reusable job plans; better reporting by asset type.",
      ...
      "signals": [
        "Assets assigned to classification hierarchy",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Manage — Classification & Specification Framework"
      ],
      "personas": [
      ...
      "respMet": "Assets are organised into a consistent classification structure with reusable specification templates. This enables job plan reuse across common asset types and makes reporting by asset class reliable — both of which compound in value as the asset population grows.",
      "respUnmet": "consequence: Without a consistent classification structure, job plans cannot be reused across asset types and reporting by asset class is unreliable — every planning and analysis capability built on top of asset data is harder to standardise. \n\neffort: Achieving this requires defining a classification hierarchy with specification templates for key asset classes and linking standard job plans to those classes to enable reuse.",
      "respUnknown": "It's unclear whether assets are organised using a formal classification structure. Your Asset Manager or Planner can confirm whether asset classes and specifications are in use and whether job plans are being reused across common asset types."
    },
    {
      "id": "AD-2-HIER",
      ...
      "apmStageId": "APM3",
      "fsmStageId": "FSM3",
      "description": "Parent-child asset hierarchies and location structures defined in Maximo to represent how critical equipment and systems are organized. Supports maintenance history analysis, cost visibility, asset rollups, and future condition and health monitoring initiatives.",
      "valueStatement": "Enables cost rollups, component-level maintenance history, and failure impact analysis across the asset lifecycle. Unlocks multi-team scheduling and shutdown planning for customers with complex asset networks.",
      ...
      "signals": [
        "Parent-child relationships defined for critical asset classes",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Manage — Asset Hierarchy & Location Records"
      ],
      "personas": [
        "Asset Manager",
        "System Administrator"
      ],
      "respMet": "Parent-child asset structures and location hierarchies are defined, giving you component-level work history and the ability to roll costs and condition up through the asset tree. This is the structural foundation that makes failure impact analysis and system-level maintenance planning possible.",
      "respUnmet": "consequence: Without parent-child asset structures and location hierarchies, cost rollups, component-level work history, and failure impact analysis cannot be performed reliably across the asset population. \n\neffort: Achieving this requires auditing existing relationships, linking physical components to parent assets, and establishing location hierarchy consistently for at least one critical asset class.",
      "respUnknown": "It's unclear whether parent-child asset hierarchies and location structures have been defined. Your Asset Manager or System Administrator can confirm whether component-level relationships exist and whether they are applied consistently."
    },
    {
      "id": "AD-3-REL",
      ...
      "apmStageId": "APM3",
      "fsmStageId": "FSM3",
      "description": "Dependencies and relationships between assets, locations, and systems modeled in Maximo to reflect how equipment operates together. Supports system-level maintenance planning, outage and shutdown planning.",
      "valueStatement": "System-level maintenance planning; better outage/shutdown planning; understanding of asset dependencies.",
      ...
      "signals": [
        "Asset relationship records defined",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Asset Relationships Application"
      ],
      "personas": [
        "Asset Manager",
        "Reliability Engineer",
      ...
      "respMet": "Asset dependencies and system relationships are modelled, meaning outage coordination and shutdown planning can be driven by structured data rather than individual knowledge. This reduces the organisational risk of key-person dependency in complex maintenance scenarios.",
      "respUnmet": "consequence: Without asset dependency and relationship records, system-level maintenance planning and outage coordination rely on individual knowledge rather than structured data — creating risk when key people are unavailable. \n\neffort: Achieving this requires mapping dependency relationships between assets and connected systems and using those relationships to inform work order sequencing and shutdown planning.",
      "respUnknown": "It's unclear whether asset dependency and relationship records have been modelled. Your Asset Manager or Reliability Engineer can confirm whether system-level relationships are defined and whether they are used in outage or shutdown planning."
    },
    {
      "id": "WM-1-JPBASIC",
      ...
      "apmStageId": null,
      "fsmStageId": "FSM1",
      "description": "Job plans exist in Maximo as reusable work templates linked to work orders and preventive maintenance records. Each job plan includes estimated duration and defined labor, craft, or crew requirements to support consistent work execution.",
      "valueStatement": "Job plans are the reuse mechanism. Without them every work order is created from scratch, increasing planning time and reducing data consistency.",
      ...
      "signals": [
        "Job plans exist and are linked to work orders and PMs for critical asset classes",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Maximo Manage — Job Plans Application",
      ...
      "respMet": "Job plans exist as reusable work templates linked to work orders and PMs, giving planners a consistent starting point for every recurring job. This is the data foundation that condition monitoring, health scoring, and downstream analytics depend on — maintenance data becomes trustworthy when work is structured rather than created from scratch each time.",
      "respUnmet": "consequence: Without job plans as reusable work templates, every work order is created from scratch — increasing planning time, producing inconsistent maintenance data, and leaving condition monitoring and health scoring without a reliable data foundation to build on. \n\neffort: Achieving this requires building standard job plan templates for common recurring activities, populating estimated duration and labour requirements, and ensuring plans are linked to work orders and PMs for critical asset classes.",
      "respUnknown": "It's unclear whether job plans exist as reusable work templates in your environment. Your Planner or Maintenance Supervisor can confirm whether structured job plans — with estimated duration and labour requirements — are linked to work orders and PMs."
    },
    {
      "id": "WM-2-JPNEEDS",
      ...
      "apmStageId": null,
      "fsmStageId": "FSM2",
      "description": "Job plans enriched with labor, materials, tools, services, work type classifications, and asset-specific requirements to support consistent planning, scheduling, and execution of maintenance work.",
      "valueStatement": "Better forecast of resources tied to job plans; increased maintenance supervisor and staff productivity.",
      ...
      "signals": [
        "Job plans include materials requirements",
      ...
      "respMet": "Job plans are enriched with materials, tools, and services, making resource forecasting reliable and reducing the parts and skill gaps that surface unexpectedly at the point of work. This enables job plans to function as active scheduling inputs rather than loose references, improving execution compliance.",
      "respUnmet": "consequence: Without materials, tools, and services planned as part of job plans, resource forecasting is unreliable and schedule execution is frequently disrupted by parts or skill gaps that surface only at the point of work. \n\neffort: Achieving this requires enriching existing job plan templates with materials, tools, services, work type classification, and using them as active scheduling inputs rather than ad hoc references.",
      "respUnknown": "It's unclear whether job plans have been enriched with materials, tools, and services. Your Planner or Maintenance Supervisor can confirm whether planned materials and resource requirements are part of the standard work planning process."
    },
    {
      "id": "WM-3-JPAR",
      ...
      "apmStageId": null,
      "fsmStageId": "FSM3",
      "description": "Job plans are structured to reflect complex maintenance activities, with related job plans generating parent-child work order hierarchies. Job plans are associated with specific asset classifications to support standardized maintenance practices across similar assets.",
      "valueStatement": "Asset-specific maintenance planning; reusable maintenance strategies scoped to asset class.",
      ...
      "signals": [
        "Job plans have native job plan structure (relationships generating WO hierarchies)",
      ...
      "respMet": "Job plans are structured to generate work order hierarchies and scoped to specific asset classifications, giving maintenance planning an asset-specific reliability rationale rather than a generic template. This enables asset-class maintenance strategies to be applied consistently and updated in one place as knowledge improves.",
      "respUnmet": "consequence: Without job plans structured to generate work order hierarchies and scoped to specific asset classifications, maintenance planning is generic rather than asset-specific — limiting the reliability rationale behind any individual work order. \n\neffort: Achieving this requires establishing native job plan relationships that generate work order hierarchies and linking job plans to asset classifications with the relevant constraints such as downtime requirements and safety conditions.",
      "respUnknown": "It's unclear whether job plans are structured to generate work order hierarchies or scoped to specific asset classifications. Your Planner or Reliability Engineer can confirm whether asset-specific job plan structures are in use."
    },
    {
      "id": "WM-3-WSO",
      ...
      "apmStageId": null,
      "fsmStageId": "FSM3",
      "description": "Technician scheduling and dispatch optimized using work priority, job urgency, required skills, location, and workforce availability. Crew assignments are matched to work requirements to improve schedule efficiency, workforce utilization, and timely completion of maintenance activities. When condition-based maintenance is used, asset condition information can also be considered to help prioritize and schedule work.",
      "valueStatement": "Reduces wasted travel time, idle technician hours, and skill mismatches. Ensures the most urgent condition-driven work gets the right technician at the right time.",
      ...
      "signals": [
        "Scheduling logic references criticality scores alongside due date or fixed PM interval",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "MAS Scheduler — Advanced Planning",
    ...
    },
    {
      ...
      "apmStageId": "APM3",
      "fsmStageId": "FSM3",
      "description": "Preventive maintenance intervals are adjusted using asset condition and health signals. Maintenance plans and work volumes are optimized to reduce unnecessary work, prioritize emerging risks, and improve asset reliability while making more effective use of field resources.",
      "valueStatement": "Reduces unnecessary planned downtime and maintenance labor cost.",
      ...
      "signals": [
        "Health score thresholds linked to PM scheduling triggers",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — PM Records & Condition-Based Trigger Rules",
      ...
      "respMet": "PM intervals are adjusted from condition and health data, meaning over-maintained assets are de-escalated and under-maintained ones are caught before failure. This reduces unnecessary planned downtime and maintenance labour cost — the value that condition-based scheduling was always intended to deliver.",
      "respUnmet": "consequence: Without PM intervals adjusted from condition data, maintenance is over-applied to assets that don't need it and under-applied to those that do — driving unnecessary planned downtime and missing the cost reduction that condition-based scheduling delivers. \n\neffort: Achieving this requires linking health score thresholds to PM scheduling triggers and establishing a process for updating PM frequencies when condition evidence justifies a change.",
      "respUnknown": "It's unclear whether PM intervals are adjusted based on condition data or health signals. Your Reliability Engineer or Maintenance Planner can confirm whether condition-based PM triggers are active and whether intervals have been revised based on asset data."
    },
    {
      "id": "WM-4-DASH",
      ...
      "apmStageId": null,
      "fsmStageId": "FSM4",
      "description": "A planning dashboard in Maximo provides real-time visibility into maintenance cost, resource capacity, and compliance performance using operational data. Planning decisions are guided by three KPI views: cost (labor, materials, tools, and services), resource (forecast demand versus available workforce capacity), and compliance (planned versus actual work execution). This enables proactive planning, improved resource allocation, and greater control of maintenance performance.",
      "valueStatement": "Makes planned-vs-actual analysis automatic and accessible. Replaces manual Power BI exports.",
      ...
      "signals": [
        "Planning Dashboard in active use with all three KPI views populated",
      ...
      "respMet": "The planning dashboard is live and populated with real cost, resource, and compliance data, making planned-versus-actual analysis automatic and accessible. This replaces manual report exports and gives planners and managers a continuously current view of scheduling performance.",
      "respUnmet": "consequence: Without a live planning dashboard, cost, resource, and compliance analysis depends on manual exports and ad hoc reports — making planned-versus-actual analysis slow, inconsistent, and difficult to act on. \n\neffort: Achieving this requires activating the three KPI views — cost, resource, and compliance — with real data, and configuring automated data generation on a scheduled basis so the dashboard stays current without manual effort.",
      "respUnknown": "It's unclear whether a Planning Dashboard is live and populated with real cost, resource, and compliance data. Your Planner or Scheduler can confirm whether the dashboard views are in active use and whether the underlying data is reliable."
    },
    {
      "id": "WM-4-JPAIP",
      ...
      "apmStageId": "APM4",
      "fsmStageId": "FSM5",
      "description": "Asset Investment Planning (AIP) outputs are integrated with job plan definitions. Job plans use asset condition, health, and risk data to drive maintenance decisions, aligning work execution with asset lifecycle and investment priorities.",
      "valueStatement": "Asset-specific maintenance planning driven by lifecycle data.",
      ...
      "signals": [
        "Job plans linked to AIP outputs or asset condition triggers",
      ...
      "respMet": "Asset Investment Planning outputs are connected to job plan definitions, meaning maintenance tasks are informed by lifecycle data as assets age, degrade, or approach end of life. This closes the loop between capital planning and field execution — job plans evolve with the assets they cover.",
      "respUnmet": "consequence: Without Asset Investment Planning connected to job plan definitions, maintenance tasks are not informed by lifecycle data — meaning job plans are not updated as assets age, degrade, or approach end of life. \n\neffort: Achieving this requires establishing AIP scenarios, linking their outputs to job plan content, and ensuring that asset condition data is used as an active input when job plan requirements are reviewed.",
      "respUnknown": "It's unclear whether Asset Investment Planning outputs are connected to job plan definitions. Your Planner or Asset Manager can confirm whether AIP is in use and whether asset condition data is influencing job plan content."
    },
    {
      "id": "WM-5-GENAI",
      ...
      "apmStageId": "APM5",
      "fsmStageId": "FSM5",
      "description": "AI-driven prescriptive recommendations guide maintenance decisions across all critical asset classes, recommending what work to perform, when to perform it, which parts and resources are required, and the optimal execution sequence.",
      "valueStatement": "Scales reliability expertise to every technician and engineer at the point of work.",
      ...
      "signals": [
        "AI-driven guidance active at the point of work execution or decision-making",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Assistant — Prescriptive GenAI Recommendations",
      ...
      "respMet": "AI-driven prescriptive recommendations are active at the point of work, scaling reliability expertise to every technician and engineer across critical asset classes. Guidance is no longer dependent on individual knowledge — it is available at the moment a decision needs to be made.",
      "respUnmet": "consequence: Without AI-driven prescriptive recommendations at the point of work, reliability expertise cannot scale beyond the individuals who hold it — technicians and engineers must rely on their own knowledge rather than data-backed guidance. \n\neffort: Achieving this requires AI-driven guidance to be active at the point of work execution across critical asset classes, with outputs connected to work order creation so recommendations result in recorded maintenance actions.",
      "respUnknown": "It's unclear whether AI-driven prescriptive recommendations are active at the point of work. Your Reliability Engineer or Maintenance Supervisor can confirm whether GenAI guidance is being used during work execution or decision-making for critical assets."
    },
    {
      "id": "IC-1-PROG",
      ...
      "valueStatement": "Establishes inspection discipline before digitization. Customers with active programs migrate faster; this milestone credits existing practice.",
      "imperative": "Establish a documented, repeatable inspection route program with standardized frequencies for critical assets.",
      "signals": [
        "Inspection rounds defined and scheduled for at least one critical asset class",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Pre-Maximo — Paper / Spreadsheet / Standalone Inspection Tool"
      ],
      "personas": [
        "Inspector",
        "Field Technician",
      ...
      "respMet": "A repeatable inspection programme is active for critical assets, with results captured consistently and a retrievable inspection history in place. This baseline of structured condition data makes digital migration faster and gives health scoring a credible input to build on.",
      "respUnmet": "consequence: Without a repeatable inspection programme, there is no structured baseline of asset condition — making it impossible to detect deterioration trends, validate health scoring inputs, or migrate to digital capture with confidence. \n\neffort: Achieving this requires defining inspection rounds for at least one critical asset class, documenting frequency and scope, and establishing a consistent method for capturing and retaining results.",
      "respUnknown": "It's unclear whether a repeatable inspection programme exists. Your Maintenance Supervisor or Inspector can confirm whether inspection rounds are scheduled for critical assets and whether results are being captured and retained consistently."
    },
    {
      "id": "IC-2-INSB",
      ...
      "valueStatement": "Establishes asset condition visibility; creates inspection history; foundation for health score inputs.",
      "imperative": "Digitize inspection forms in Maximo to capture field inspection results directly against asset records.",
      "signals": [
        "Inspection records exist in Maximo for at least one asset class",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Inspection Forms Application",
      ...
      "respMet": "Digital inspection records are linked to asset records in real time, replacing paper-lagged capture with a structured, queryable inspection history. Condition monitoring and health scoring now have one of their most important structured inputs available consistently.",
      "respUnmet": "consequence: Without digital inspection records linked to asset records, inspection results remain paper-lagged rather than feeding real-time analytics — and condition monitoring and health scoring lack one of their most important structured inputs. \n\neffort: Achieving this requires deploying digital inspection forms for at least one asset class, capturing results on a mobile device, and confirming that results link back to the correct asset record.",
      "respUnknown": "It's unclear whether inspection records are captured digitally and linked to asset records in your system. Your Inspector or Maintenance Supervisor can confirm whether digital inspection forms are in use and whether results are traceable to specific assets."
    },
    {
      "id": "IC-3-METB",
      ...
      "valueStatement": "fsm: Establishes baseline asset usage tracking for usage-based PM generation and field visibility.\napm: Provides the foundational operating condition data required for health scoring.",
      "imperative": "Capture routine meter and condition readings in Maximo against asset records.",
      "signals": [
        "Meter reading records active and updated consistently for critical assets",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Monitor — Meter Readings & Condition Data",
      ...
      "respMet": "Operating meter readings are routinely captured and maintained on asset records, establishing the usage data foundation needed for accurate preventive maintenance intervals and asset health scoring.",
      "respUnmet": "consequence: Without consistent meter reading capture, usage-based PMs and condition health algorithms lack the operational data required to assess true asset runtime or degradation.\n\neffort: Achieving this requires setting up meter definitions on critical asset records and establishing a consistent routine for capturing readings via Maximo Mobile or periodic batch imports.",
      "respUnknown": "It's unclear whether meter readings are consistently captured against asset records. Your Maintenance Supervisor or Reliability Engineer can confirm whether meter reading routines are active."
    },
    {
      "id": "IC-3-MVI",
      ...
      "valueStatement": "Reduces missed defects; digital capture enables defect tracking over time.",
      ...
      "signals": [
        "Visual inspection records captured digitally for at least one asset class",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Mobile — Visual Inspection Capture",
      ...
      "respMet": "AI-assisted visual inspection is active, with defect records linked digitally to asset and work order records. Defects that would previously fall between scheduled intervals are now detectable, and a digital visual condition history is accumulating for trend analysis.",
      "respUnmet": "consequence: Without AI-assisted visual inspection, defects that fall between scheduled inspection intervals go undetected, and there is no digital record of visual condition history to track deterioration over time. \n\neffort: Achieving this requires deploying digital visual inspection capture for at least one asset class, linking defect records to asset and work order records, and — where applicable — activating visual inspection models.",
      "respUnknown": "It's unclear whether AI-assisted visual inspection is in use. Your Inspector or Reliability Engineer can confirm whether digital visual capture is active, whether defect records are linked to assets, and whether MVI models have been deployed."
    },
    {
      "id": "SCH-1-DATES",
      ...
      "valueStatement": "Without scheduled dates there is no basis for resource planning, capacity analysis, or forward scheduling.",
      ...
      "signals": [
        "Work orders have scheduled start and scheduled finish populated (not target, anticipated, or estimated dates)",
      ...
      "respMet": "Work orders carry scheduled start and finish dates, giving you the basis for measuring schedule compliance and understanding whether work is being executed when intended. This is the data foundation that forward planning, constraint-based scheduling, and optimisation all depend on.",
      "respUnmet": "consequence: Without scheduled start and finish dates on work orders, there is no basis for measuring schedule compliance, planning resource demand, or understanding whether maintenance work is being executed when intended. \n\neffort: Achieving this requires populating scheduled start and scheduled finish dates on active work orders — distinct from target or estimated dates — and establishing a practice for maintaining those dates as the schedule evolves.",
      "respUnknown": "It's unclear whether work orders have scheduled start and finish dates consistently populated. Your Planner or Maintenance Supervisor can confirm whether scheduling fields are in use and what percentage of active work orders carry valid scheduled dates."
    },
    {
      "id": "SCH-2-FWD",
      ...
      "valueStatement": "Forward planning enables resource balancing and backlog management. Routine work begins to find its slot automatically.",
      "imperative": "Build and manage rolling multi-week forward schedules to balance near-term execution with future backlog.",
      "signals": [
        "Schedules extend 2+ weeks into the future (T-week scheduling)",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Graphical Work Week — Multi-Week Planning View",
      ...
      "respMet": "Schedules extend across a multi-week horizon, meaning resources are assigned to anticipated work rather than only to what is already imminent. This makes backlog management proactive and gives planners the window needed to identify conflicts and shortages before they affect execution.",
      "respUnmet": "consequence: Without multi-week forward schedules, maintenance planning is reactive and horizon-blind — resources are assigned to work that is already imminent rather than anticipated and prepared for across an extended window. effort: Achieving this requires producing schedules that extend at least two weeks into the future and actively managing the backlog within that horizon — starting with one team or one site where planning discipline is already strongest before rolling out more broadly.",
      "respUnknown": "It's unclear whether scheduling extends across a multi-week horizon. Your Planner or Scheduler can confirm whether T-week schedules are being produced and whether the active backlog is managed within a defined planning window."
    },
    {
      "id": "SCH-3-CONS",
      ...
      "valueStatement": "Prevents incorrect work sequencing; reduces manual intervention. System begins taking decisions with your definitions.",
      ...
      "signals": [
        "Work orders use predecessor relationships (work B cannot start until work A is complete)",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "MAS Scheduler — Core Scheduling Engine",
      ...
      "respMet": "Predecessor relationships, work order hierarchies, and rolling schedule periods are active, allowing dependent work to be sequenced automatically rather than re-planned manually each week. Planning horizon now extends to monthly or longer, enabling a level of coordination that week-by-week scheduling cannot support.",
      "respUnmet": "consequence: Without predecessor relationships, work order hierarchies, and rolling schedule periods, scheduling requires constant manual intervention to re-sequence dependent work — limiting the planner's ability to manage beyond a single week. \n\neffort: Achieving this requires establishing predecessor and parent-child relationships on work orders, activating rolling schedule periods so the system repeats planning automatically, and extending the planning horizon to monthly or longer.",
      "respUnknown": "It's unclear whether constraint-based scheduling with predecessor relationships and rolling periods is in use. Your Planner or Scheduler can confirm whether work order hierarchies and predecessor logic are actively applied in the scheduling process."
    },
    {
      "id": "SCH-4-OPT",
      ...
      "valueStatement": "Scalable scheduling operations; faster schedule generation; optimized resource utilization; reduced planner effort.",
      ...
      "signals": [
        "Cron jobs configured for optimization, rolling schedules, cost calculation, and compliance calculation",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "MAS Scheduler with Optimizer — Automated Optimization Engine",
        "Maximo Manage — Cron Task Framework"
      ],
      "personas": [
        "Planner",
      ...
      "respMet": "The Optimizer is running automatically on a cron schedule, generating schedules without a manual trigger and allowing planners to act as reviewers rather than creators. Scheduling decisions are now consistent and objective — driven by configured constraints rather than individual judgment.",
      "respUnmet": "consequence: Without automated optimisation, scheduling decisions remain manual — planners are creating schedules by hand rather than reviewing and approving system-generated ones, limiting both scale and consistency. \n\neffort: Achieving this requires configuring the Optimizer with objectives and constraints, setting up cron-based scheduling so it runs without a manual trigger, and establishing a review process where planners act as approvers of system output.",
      "respUnknown": "It's unclear whether automated schedule optimisation is running. Your Planner or Operations Manager can confirm whether the Optimizer is configured with objectives and constraints, and whether it is running without a manual trigger."
    },
    {
      "id": "SCH-5-AUTO",
      ...
      "valueStatement": "Maximum scheduling efficiency; minimal manual intervention; continuous optimization.",
      ...
      "signals": [
        "Cron tasks running for all scheduling and calculation functions",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "MAS Scheduler with Optimizer — Full Automation",
        "Maximo Manage — Cron Task Framework",
        "MAS Scheduler — Planning Dashboard"
      ],
      "personas": [
      ...
      "respMet": "Scheduling is fully automated at scale, with cron tasks running for all scheduling functions and planners focused entirely on exception management. High-quality operational data is maintained continuously, giving the system what it needs to make reliable autonomous decisions.",
      "respUnmet": "consequence: Without fully automated scheduling, operational data quality and scale are insufficient for the system to manage routine assignments independently — planners are still creators rather than exception handlers. \n\neffort: Achieving this requires cron tasks running for all scheduling functions, high-quality operational data maintained continuously, and a clearly defined exception management process so planners focus only on what the system escalates.",
      "respUnknown": "It's unclear whether scheduling is fully automated with humans acting as approvers only. Your Operations Manager or System Administrator can confirm whether cron tasks are running for all scheduling functions and whether the Optimizer is operating at full scale."
    },
    {
      "id": "AS-1-OWN",
      ...
      "valueStatement": "Using owner instead of assignment prevents work from flowing through mobile, dispatch, and availability calculations. Resolving this unblocks every downstream FSM capability.",
      "imperative": "Allocate work using standard Maximo Assignment records rather than static record ownership or person groups.",
      "signals": [
        "Work orders are assigned using the Assignment object (labor or crew assigned)",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Maximo Manage — Work Order Assignments",
      ...
      "respMet": "Work is assigned through the Assignments object, giving the system accurate visibility into who is performing work and what resource capacity is actually committed. This is the data foundation that effective availability calculation, centralised dispatch, and automated assignment all depend on.",
      "respUnmet": "consequence: Without work assigned through the Assignments object, the system cannot accurately track who is performing work or calculate effective resource availability — creating a data gap that undermines every scheduling and dispatch capability above this level. \n\neffort: Achieving this requires migrating away from the Owner or Person Group fields for assignment tracking and ensuring all work is allocated through the Assignments object, with Maximo Mobile adoption reinforcing the practice in the field.",
      "respUnknown": "It's unclear whether work is being assigned using the Assignments object rather than the Owner or Person Group fields. Your Maintenance Supervisor or System Administrator can confirm the current assignment practice and whether Maximo Mobile is in use for field execution."
    },
    {
      "id": "AS-2-CENT",
      ...
      "valueStatement": "Centralized management enables visibility of resource conflicts and prevents double-booking across departments.",
      ...
      "signals": [
        "Assignment Manager application actively used by a centralized scheduler/dispatcher role",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Assignment Manager — Centralized Dispatch View",
      ...
      "respMet": "A centralised scheduler or dispatcher manages work assignments through Assignment Manager, with cross-team workloads visible from a single view. This replaces fragmented supervisor-level allocation with a coordinated picture of demand against available resource.",
      "respUnmet": "consequence: Without centralised assignment management, workload visibility is fragmented across supervisors and teams — making it impossible to balance demand against available resource or identify conflicts without manually aggregating information from multiple sources. effort: Achieving this requires a designated scheduler or dispatcher actively using Assignment Manager as the single point of control — beginning with one team's work to establish the practice and demonstrate the visibility benefit before expanding to the full workforce.",
      "respUnknown": "It's unclear whether a centralised scheduler or dispatcher is managing work assignments through Assignment Manager. Your Scheduler or Dispatcher can confirm whether Assignment Manager is in active use and whether workloads are visible across teams from a single view."
    },
    {
      "id": "AS-3-BEST",
      ...
      "valueStatement": "Higher first-time fix rates; improved workforce utilization; reduced scheduling conflicts.",
      ...
      "signals": [
        "Customer uses the \"available labor\" or \"available crew\" action in Maximo",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "MAS Scheduler — Skill/Availability Matching",
    ...
    },
    {
      ...
      "valueStatement": "Reduced manual dispatch effort; faster assignment decisions; scalable workforce planning.",
      ...
      "signals": [
        "Optimizer outputs generating work assignments (system-generated, not manually created)",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Optimizer — Automated Assignment Engine",
      ...
      "respMet": "The Optimizer is generating workforce assignments automatically, with dispatchers focused on reviewing and overriding exceptions rather than building schedules from scratch. Dispatch throughput and consistency have improved without adding headcount — the system handles routine allocation at a scale no manual process can match.",
      "respUnmet": "consequence: Without Optimizer-driven assignment, dispatchers are manually creating routine assignments rather than managing exceptions — limiting throughput, introducing inconsistency, and preventing the organisation from scaling dispatch without adding headcount. \n\neffort: Achieving this requires configuring skill levels and priorities as Optimizer parameters and establishing the process discipline for dispatchers to review and override system-generated assignments rather than build them from scratch.",
      "respUnknown": "It's unclear whether Optimizer-driven assignment is generating work assignments automatically. Your Dispatcher or Operations Manager can confirm whether the Optimizer is producing assignments and whether the dispatcher role has shifted to exception management."
    },
    {
      "id": "AS-5-FULL",
      ...
      "valueStatement": "Maximum dispatch efficiency; consistent high-quality assignments; scalable operations.",
      "imperative": "Deploy autonomous dispatch and real-time schedule re-optimization across the entire field workforce.",
      "signals": [
        "Optimizer outputs driving all routine assignments automatically",
      ...
      "respMet": "Workforce planning is fully automated with role-based optimisation constraints encoded, and routine assignment is entirely system-managed. Dispatchers operate as exception handlers — the system escalates only what requires human judgment.",
      "respUnmet": "consequence: Without fully automated dispatch, role-based optimisation constraints are not fully encoded and routine assignment still requires manual effort — meaning the dispatcher role has not yet shifted to exception management at scale. \n\neffort: Achieving this requires all routine assignments to be system-managed, role-based optimisation constraints fully configured, and a well-defined exception management process so dispatchers focus only on what the system escalates.",
      "respUnknown": "It's unclear whether workforce planning is fully automated with role-based optimisation constraints configured. Your Operations Manager or Dispatcher can confirm whether routine assignments are entirely system-managed and what proportion of work still requires manual dispatch."
    },
    {
      "id": "WA-1-BAS",
      ...
      "valueStatement": "Without calendar + shift + craft, Maximo cannot calculate resource availability, cost per hour, or Optimizer inputs. All scheduling, dispatch, and mobile assignment flows break without this foundation.",
      "imperative": "Maintain baseline labor records in Maximo populated with active calendars, shifts, and assigned crafts.",
      "signals": [
        "Labor records exist (distinct from users and people records)",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Maximo Manage — Labor Records & Craft Application",
      ...
      "respMet": "Labour records are complete with calendar, shift, and craft populated for all field staff, making every person a schedulable resource the system can plan against. This is the minimum data layer that capacity planning, assignment proposals, and effective availability calculation all require.",
      "respUnmet": "consequence: Without complete labour records — calendar, shift, and craft — the system cannot treat people as schedulable resources, making any capacity planning or assignment output unreliable by definition. \n\neffort: Achieving this requires creating or completing labour records for all field staff, ensuring each record has calendar, shift, and a specific craft value, and — where applicable — establishing crew records with the same minimum fields.",
      "respUnknown": "It's unclear whether labour records are set up with the minimum required fields — calendar, shift, and craft — to make each person schedulable. Your System Administrator or Maintenance Supervisor can confirm whether labour records exist and whether they are complete."
    },
    {
      "id": "WA-2-ACT",
      ...
      "valueStatement": "More accurate planning; realistic workforce capacity; reduced scheduling conflicts.",
      ...
      "signals": [
        "Labor records have modify availability entries (vacations, training, non-working time)",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "MAS Scheduler — SNLT/FNLT Constraint Fields",
      ...
      "personas": [
        ...
        "Planner",
        "Maintenance Supervisor",
        "IT / Platform Owner (if HR integration)"
      ],
      "respMet": "Modified availability entries are actively maintained, capturing vacations, training, and exceptions so the system's view of available capacity reflects reality rather than a static calendar. Assignments made against this data can actually be honoured — reducing the hidden overloads that appear when capacity is overstated.",
      "respUnmet": "consequence: Without modified availability entries capturing exceptions such as vacations, training, and unplanned absence, the system's view of available capacity is based on a static calendar that does not reflect reality — leading to assignments that cannot be honoured. \n\neffort: Achieving this requires supervisors actively maintaining availability exceptions on labour records and — where an HR system is in place — establishing an integration so that exceptions flow in automatically rather than relying on manual entry.",
      "respUnknown": "It's unclear whether modified availability entries — covering vacations, training, and exceptions — are being maintained on labour records. Your Scheduler or Maintenance Supervisor can confirm whether availability exceptions are captured and whether any HR system integration is in place."
    },
    {
      "id": "WA-3-EFF",
      ...
      "valueStatement": "True resource capacity visibility; improved assignment quality; Optimizer readiness.",
      ...
      "signals": [
        "Available labor views used actively for dispatch decisions",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "MAS Scheduler — Effective Availability Model",
      ...
      "respMet": "Effective availability is calculated dynamically from static availability, modifications, and current assignments — giving dispatchers a capacity figure that accounts for already-committed work. Invisible overloads are eliminated, and demand can be weighed against genuine supply before assignments are confirmed.",
      "respUnmet": "consequence: Without effective availability calculated dynamically from static availability, modifications, and current assignments, dispatch decisions are made against a capacity number that does not account for already-committed work — creating invisible overloads. \n\neffort: Achieving this requires activating availability views that deduct current assignments from capacity and ensuring that demand is visible against supply in the scheduling interface before assignments are made.",
      "respUnknown": "It's unclear whether effective availability is being calculated dynamically from static availability, modifications, and current assignments. Your Scheduler or Dispatcher can confirm whether available labour views are used for dispatch decisions and whether demand is visible against supply."
    },
    {
      "id": "CM-1-LF",
      ...
      "valueStatement": "Establishes condition-based maintenance workflows without requiring full IoT infrastructure investment. Builds team confidence in using asset condition data.",
      ...
      "signals": [
        "Condition monitoring records active in Maximo Manage for at least one critical asset class",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Condition Monitoring Records & Threshold Configuration",
      ...
      "respMet": "Condition data is being captured and threshold alerts are active, with automated work order creation triggered when a threshold is breached. This establishes the condition-based maintenance workflow — decisions are no longer made solely from calendar schedules and failure history.",
      "respUnmet": "consequence: Without any condition data capture, there is no foundation for condition-based maintenance — decisions are made entirely from calendar schedules and failure history rather than the current state of the asset. \n\neffort: Achieving this requires activating condition monitoring records for at least one critical asset class, configuring threshold alerts, and establishing automated work order creation when a threshold is breached.",
      "respUnknown": "It's unclear whether condition monitoring records and threshold-based triggers are active. Your Reliability Engineer or Asset Manager can confirm whether condition data is being collected at defined intervals and whether automated work orders are being generated from threshold breaches."
    },
    {
      "id": "CM-2-HLTH",
      ...
      "valueStatement": "Replaces gut-feel asset condition judgment with a scored, data-backed view — giving maintainers a single number that reflects real asset health.",
      "imperative": "Activate out-of-the-box asset health scoring in Maximo Health for at least one critical asset class.",
      "signals": [
        "OOB Health activated and health score switch turned on",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Health — Health Score Configuration, Data Source Mapping, Asset Health Dashboard",
      ...
      "respMet": "Health scoring is active for at least one critical asset class, giving maintainers a single scored view of asset condition rather than checking each data source separately. This replaces gut-feel assessment with a data-backed number, enabling proactive prioritisation and building the team confidence needed to extend health scoring to additional classes.",
      "respUnmet": "consequence: Without health scoring, maintainers are assessing asset condition by checking each data source separately rather than from a single scored view — making proactive prioritisation inconsistent and dependent on individual judgment. \n\neffort: Achieving this requires activating out-of-the-box health scoring starting with one critical asset class where data quality is already sufficient, drawing from at least one scoring factor, and building the team's confidence in interpreting and acting on scores before expanding scope.",
      "respUnknown": "It's unclear whether out-of-the-box health scoring has been activated. Your Reliability Engineer or Administrator can confirm whether health scores are turned on, which scoring factors are in use, and whether the team has the foundational knowledge to build on them."
    },
    {
      "id": "CM-2-MON",
      ...
      "valueStatement": "Enables condition-based insights without full real-time OT/IoT investment. Extends health scoring beyond WO and inspection data.",
      ...
      "signals": [
        "Monitor data ingestion pipeline active with at least 1 data feed",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Monitor — CSV/EDC/REST/MQTT Lightweight Ingestion",
      ...
      "respMet": "A condition data ingestion pipeline is active and periodic readings are visible in trend views for at least one asset. This extends health scoring beyond work order history and inspection records, adding the richer operational signal that earlier and more accurate detection depends on.",
      "respUnmet": "consequence: Without a periodic condition data ingestion pipeline, health scoring is limited to work order history and inspection records — missing the richer signal that operational data sources provide for earlier and more accurate detection. \n\neffort: Achieving this requires establishing one data feed for one asset using lightweight ingestion methods such as CSV import, REST API, or historian extracts, and confirming that data is visible in trend views — the goal is to prove the pipeline before broadening it.",
      "respUnknown": "It's unclear whether a periodic condition data ingestion pipeline is active in Maximo Monitor. Your Reliability Engineer or Administrator can confirm whether at least one data feed is running and whether Monitor data is contributing to any health score factor."
    },
    {
      "id": "CM-2-TRIG",
      ...
      "valueStatement": "Shifts maintenance from fixed calendar intervals to condition-driven intervention — preventing premature failures and eliminating unnecessary routine maintenance.",
      ...
      "signals": [
        "Condition monitoring points configured with upper/lower action limits",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Condition Monitoring Points",
      ...
      "respMet": "Condition-based maintenance triggers are active in Maximo, automatically generating work orders or adjusting PM schedules when asset condition limits are breached. This operationalizes CBM+ and catches degradation before failure occurs.",
      "respUnmet": "consequence: Without automated condition-based triggers, condition data remains informational only — relying on manual inspection review and failing to prevent threshold-breach failures in real time.\n\neffort: Achieving this requires configuring condition monitoring points with defined action limits in Maximo Manage and linking them to standard job plans for automatic work generation.",
      "respUnknown": "It's unclear whether automated condition triggers are configured in Maximo. Your Reliability Engineer or System Administrator can confirm whether condition monitoring points actively generate work orders on threshold breaches."
    },
    {
      "id": "CM-3-IOT",
      ...
      "valueStatement": "Real-time asset condition visibility eliminates blind spots between PM windows. Enables data-driven prioritization and earlier detection.",
      "imperative": "Stream real-time OT and IoT sensor telemetry into Maximo Monitor mapped to asset hierarchy and failure modes.",
      "signals": [
        "Live OT/IoT data streams active in Maximo Monitor for at least 1 critical asset class",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Monitor — OT/IoT Data Ingestion & Stream Processing",
      ...
      "respMet": "Live OT and IoT sensor data is integrated for at least one critical asset class, eliminating the blind spots between PM windows where degradation previously developed undetected. Asset condition is now visible continuously, enabling data-driven prioritisation instead of calendar-based guessing.",
      "respUnmet": "consequence: Without live OT and IoT sensor data integrated, asset condition is only visible at the frequency of manual reads or periodic imports — leaving blind spots between PM windows where degradation can develop undetected. \n\neffort: Achieving this requires establishing live data streams for one critical asset class where sensor infrastructure already exists and mapping that data to asset context and health scoring factors — depth on a known set of assets before expanding to others.",
      "respUnknown": "It's unclear whether live OT or IoT sensor data has been integrated into Maximo Monitor. Your Reliability Engineer or Administrator can confirm whether real-time data streams are mapped to asset context and whether they are contributing to health score factors."
    },
    {
      "id": "CM-3-MVAR",
      ...
      "valueStatement": "Objective, real-time asset health visibility replaces subjective condition assessment. Enables proactive work prioritization.",
      ...
      "signals": [
        "Health scores drawing from at least 4 factors (OT + inspection + WO) for at least 1 critical asset class",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Health — Multivariable Health Score Engine",
      ...
      "respMet": "Health scores are drawing from multiple input types — OT data, inspections, and work order history — and thresholds are actively triggering work orders. Objective, real-time health visibility now drives proactive prioritisation instead of subjective condition assessment, reducing reactive maintenance cycles.",
      "respUnmet": "consequence: Without health scores drawing from multiple input types — OT data, inspections, and work order history — condition assessment remains partial and subjective, and the automated work order triggers that reduce reactive maintenance cycles are not in place. \n\neffort: Achieving this requires building a custom health score for your highest-priority asset class first, drawing from at least four factors, and configuring health score thresholds to trigger work orders automatically before extending the model to other classes.",
      "respUnknown": "It's unclear whether health scores are drawing from multiple input types — OT data, inspections, and work order history. Your Reliability Engineer or Asset Manager can confirm whether custom health scores are active and whether work orders are being triggered from health alerts."
    },
    {
      "id": "CM-4-PRED",
      ...
      "valueStatement": "Shifts from condition monitoring ('how is it now') to genuine failure prediction ('when will it fail and why').",
      ...
      "signals": [
        "Predictive model live in production for at least 1 critical asset class",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Predict — Failure Probability Scoring & Dashboard",
    ...
    },
    {
      ...
      "valueStatement": "Transforms reliability from reactive fire-fighting to a continuous improvement discipline.",
      ...
      "signals": [
        "% of service requests or WOs created from Health/Predict alerts (not only from failures)",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Health Dashboard — Alert-to-Investigation Workflow",
      ...
      "respMet": "Health and predictive alerts are triggering engineering investigations before failure, with findings feeding back into FMEA records and job plan revisions. Reliability is no longer a reactive discipline — each investigation cycle improves the models and strategies that drive the next one.",
      "respUnmet": "consequence: Without proactive root-cause investigations triggered from health and predictive signals, FMEA records and job plans only improve after failures occur — keeping the organisation in a reactive reliability cycle rather than a continuous improvement one. effort: Achieving this requires establishing a process where health or predictive alerts trigger investigation work orders before failure, beginning with one asset class or one failure mode, with findings fed back into FMEA records and job plan revisions to close the loop.",
      "respUnknown": "It's unclear whether health and predictive alerts are routinely triggering engineering investigations before failure. Your Reliability Engineer or Maintenance Engineer can confirm whether root-cause-before-failure is standard practice and whether FMEA and job plans are being updated as a result."
    },
    {
      "id": "CM-6-LCFDBK",
      ...
      "valueStatement": "Closes the reliability loop: assets designed and procured based on real failure evidence, not OEM assumptions.",
      ...
      "signals": [
        "Asset timeline in Maximo Predict showing full failure and maintenance history for at least 1 critical asset class",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Predict — End-of-Life Forecast & Asset Timeline",
    ...
    },
    {
      ...
      "valueStatement": "Failure codes are the raw material for all downstream reliability analysis. Without structured failure data, FMEA has no operational evidence and Reliability Strategies cannot be validated.",
      ...
      "signals": [
        "Failure codes populated on closed work orders for at least one critical asset class (not left null or set to a single catch-all value)",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Maximo Manage — Failure Codes Application",
      ...
      "respMet": "Structured failure codes are captured consistently on closed work orders for critical asset classes, giving you a reliable, reportable failure history. This is the data discipline that FMEA, health scoring, and predictive models depend on — every downstream reliability capability is stronger because the input layer is trustworthy.",
      "respUnmet": "consequence: Without structured failure codes captured on closed work orders, maintenance data is not reliable enough to act on — and every downstream capability including health scoring, FMEA, and predictive models depends on the data discipline established here. \n\neffort: Achieving this requires governing a failure code library with specific, repeatable problem-cause-remedy values, ensuring those codes are populated on closed work orders for at least one critical asset class, and confirming that failure trend reports are generatable from the structured data.",
      "respUnknown": "It's unclear whether structured failure codes — problem, cause, and remedy — are being populated on closed work orders. Your Maintenance Supervisor or Reliability Engineer can confirm whether the failure code library is in use, governed, and producing reportable failure history."
    },
    {
      "id": "RP-2-RS",
      ...
      "valueStatement": "Maintenance tasks are now tied to why an asset fails, not just when it was last serviced. Reduces unnecessary maintenance.\nJob plans tied to failure modes improves maintenance quality.",
      ...
      "signals": [
        "Reliability Strategies activated in MAS",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Failure Codes & Problem/Cause/Remedy",
      ...
      "respMet": "Reliability Strategies are activated and maintenance tasks are tied to why assets fail, not just when they were last serviced. Unnecessary work is being reduced, job plan accuracy is measurably improving, and every work order now has a reliability rationale behind it.",
      "respUnmet": "consequence: Without Reliability Strategies activated, maintenance tasks are tied to when an asset was last serviced rather than why it fails — meaning unnecessary work continues, job plan accuracy cannot be measured, and there is no reliability rationale behind the work order queue. effort: Achieving this requires activating Reliability Strategies starting with one critical asset class, linking job plans to failure modes for that class, and establishing a baseline measure of job plan accuracy so improvement can be tracked before broadening scope.",
      "respUnknown": "It's unclear whether Reliability Strategies is activated and driving maintenance decisions. Your Reliability Engineer or Maintenance Manager can confirm whether job plans are linked to failure modes via Reliability Strategies and whether maintenance task accuracy has measurably improved."
    },
    {
      "id": "RP-3-FMEA",
      ...
      "valueStatement": "Governs baseline PM strategies. Reduces reactive cycles by establishing evidence-based maintenance tasks tied to failure modes.",
      ...
      "signals": [
        "FMEA mapped for at least 1 critical asset class",
      ...
      "respMet": "A baseline FMEA is mapped for at least one critical asset class, with FMEA-derived job plans driving PMs for that equipment. PM strategies are now governed by evidence-based failure mode analysis rather than generic schedules, reducing reactive maintenance cycles and providing the foundation for condition-based and predictive work.",
      "respUnmet": "consequence: Without a baseline FMEA mapped to critical asset classes, maintenance strategies are generic rather than evidence-based — keeping the organisation in more reactive maintenance cycles than necessary and providing no structured foundation for condition-based or predictive work. effort: Achieving this requires documenting failure modes and effects for one critical asset class first, deriving job plans from those failure modes, and confirming that PMs are being generated from the FMEA-linked plans — this class becomes the template for others.",
      "respUnknown": "It's unclear whether a baseline FMEA has been mapped for critical asset classes. Your Reliability Engineer or Maintenance Manager can confirm whether failure modes and effects have been documented, whether FMEA-derived job plans exist, and whether PMs are being generated from them."
    },
    {
      "id": "RP-4-RCBF",
      ...
      "valueStatement": "Reliability knowledge base improves continuously as assets operate. Maintenance strategies get smarter with each investigation cycle.",
      ...
      "signals": [
        "At least one FMEA failure mode record updated following a RCBF investigation work order",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Reliability Strategies — FMEA Builder & Version Management",
    ...
    },
    {
      ...
      "valueStatement": "FMEA becomes a living document that continuously improves maintenance strategy.",
      ...
      "signals": [
        "FMEA version history updated and published in RS for all critical asset classes",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — FMEA-Linked Job Plans & PM Records",
    ...
    },
    {
      ...
      "valueStatement": "Credits existing parts tracking practice. Customers migrating from competitor tools already have this data — the milestone acknowledges their starting point.",
      ...
      "signals": [
        "Parts catalogue exists with item numbers and descriptions",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Pre-Maximo — Spreadsheet / ERP / Competitor CMMS"
      ],
      "personas": [
        "Inventory / Storeroom Coordinator",
        "Planner",
        "Maintenance Supervisor"
      ],
      "respMet": "A parts catalogue with item numbers, stocking locations, and a responsible team for parts management is in place, with parts consumption tracked against work. This is the baseline that makes planned materials, reorder points, and any future inventory optimisation possible to build on.",
      "respUnmet": "consequence: Without a known parts catalogue and stocking locations, there is no foundation for parts planning — meaning procurement is reactive, consumption is untracked, and any future inventory optimisation has no baseline to build from. \n\neffort: Achieving this requires identifying item numbers and descriptions for maintenance spares, establishing stocking locations, and assigning a responsible team for parts management with at least a basic method for tracking parts consumed against work.",
      "respUnknown": "It's unclear whether a parts catalogue exists for maintenance spares. Your Inventory Coordinator or Maintenance Supervisor can confirm whether item numbers, stocking locations, and a responsible team for parts management have been identified."
    },
    {
      "id": "SC-2-BASICS",
      ...
      "valueStatement": "Improved material availability; reduced work delays; better inventory visibility.",
      ...
      "signals": [
        "Inventory records maintained in Maximo storeroom applications",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Inventory / Storeroom Applications"
      ],
      "personas": [
        "Inventory / Storeroom Coordinator",
        "Planner",
      ...
      "respMet": "Inventory records are maintained with reorder points configured for critical spares, and parts are associated with work orders and tracked in the storeroom. Stock levels are known and controlled — the stockouts and over-stocking that come from unmanaged inventory are now avoidable.",
      "respUnmet": "consequence: Without inventory management practices established in a CMMS, stock levels are unknown or uncontrolled — leading to both over-stocking of slow-moving items and stockouts on critical spares at the point of need. \n\neffort: Achieving this requires creating inventory records with reorder points configured for critical spares, associating parts to work orders, and confirming that stock is actively tracked and replenished against defined thresholds.",
      "respUnknown": "It's unclear whether inventory management practices — storeroom records, reorder points, and parts-to-work-order association — are established. Your Inventory Coordinator or Planner can confirm whether stock is actively tracked and whether reorder points are configured for critical spares."
    },
    {
      "id": "SC-3-PLAN",
      ...
      "valueStatement": "Reduced schedule delays; higher schedule compliance; improved maintenance efficiency.",
      ...
      "signals": [
        "Work orders contain planned materials before execution begins",
    ...
    },
    {
      ...
      "valueStatement": "Lowers carrying cost on slow-moving or excess stock while protecting availability for parts tied to imminent, condition-flagged failures.",
      ...
      "signals": [
        "Critical spares identified and stocked based on asset criticality",
      ...
      "respMet": "Inventory is managed by criticality tier, demand forecasting, and condition signals, with FMEA failure modes linked to specific spare part numbers so condition alerts can drive procurement. Carrying cost on slow-moving stock is reduced while availability of parts tied to condition-flagged failures is protected.",
      "respUnmet": "consequence: Without inventory managed by criticality, demand forecasting, and condition signals, carrying cost accumulates on slow-moving stock while critical spares tied to imminent condition-flagged failures may not be available when needed. effort: Achieving this requires starting with the spares catalogue for one critical asset class — identifying critical spares by criticality tier, generating demand forecasts from historical consumption, and linking FMEA failure modes to specific part numbers so condition alerts can trigger procurement.",
      "respUnknown": "It's unclear whether inventory is managed based on criticality, demand forecasting, and condition signals. Your Inventory Coordinator or Operations Manager can confirm whether critical spares are identified, whether turnover is monitored, and whether demand forecasts are being generated."
    },
    {
      "id": "SC-5-STRAT",
      ...
      "valueStatement": "MRO inventory productivity improvement. Reduces carrying cost while maintaining service levels for critical assets.",
      ...
      "signals": [
        "Inventory decisions driven by asset criticality and lifecycle forecasts",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Storeroom & MRO Inventory Management",
      ...
      "respMet": "Inventory strategy is aligned with asset lifecycle planning and condition risk, with reorder points updated when predicted failure risk changes and supply chain KPIs actively monitored. Stocking decisions are continuously refined rather than set once — inventory policy stays current with the actual risk profile of the asset population.",
      "respUnmet": "consequence: Without inventory strategy aligned to asset lifecycle planning and condition risk, reorder points are set once and rarely revisited — creating a widening gap between stocking policy and the actual risk profile of the asset population. \n\neffort: Achieving this requires stocking decisions to be driven by lifecycle forecasts and condition risk outputs, reorder points to be updated when predicted failure risk changes, and supply chain KPIs to be actively monitored so strategy can be refined continuously.",
      "respUnknown": "It's unclear whether inventory strategy is aligned with asset lifecycle planning and strategic sourcing. Your Storeroom Manager or Asset Manager can confirm whether stocking decisions are driven by lifecycle forecasts, whether reorder points reflect condition risk, and whether supply chain KPIs are actively monitored."
    },
    {
      "id": "HS-2-JPS",
      ...
      "valueStatement": "Workers go home safe. Hazard visibility at the point of work execution.",
      ...
      "signals": [
        "Work orders for high-risk activities have permit-to-work records linked",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo HSE — Permit to Work, Hazard Management",
      ...
      "respMet": "Safety procedures, permit requirements, and hazard controls are embedded in work execution plans and visible to technicians on their mobile device during field execution. Safety-critical information is reliably present at the point of work — not dependent on a supervisor remembering to communicate it before a job starts.",
      "respUnmet": "consequence: Without safety procedures, permit requirements, and hazard controls embedded in work execution plans, safety-critical information is not reliably visible to the technician at the point of work — increasing the risk of incidents on high-hazard activities. \n\neffort: Achieving this requires linking permit-to-work records to work orders for high-risk activities, attaching hazard management records, activating permit approval workflows, and confirming that safety information is accessible on the mobile device during field execution.",
      "respUnknown": "It's unclear whether safety procedures and permit-to-work requirements are embedded in work execution plans. Your Safety Officer or Maintenance Supervisor can confirm whether permit records are linked to high-risk work orders, whether hazard management records are in use, and whether safety information is accessible in the field."
    },
    {
      "id": "HS-2-INC",
      "name": "Incidents",
      ...
      "valueStatement": "Improved worker safety; reduced operational risk; organizational learning from failures.",
      ...
      "signals": [
        "Incident records captured in Maximo HSE",
      ...
      "respMet": "Incident, near-miss, and hazard records are captured in the system with corrective actions tracked to closure and root cause investigations on record for significant events. Safety trend analysis is possible from structured data, and the organisation can demonstrate whether its safety programme is improving over time.",
      "respUnmet": "consequence: Without structured incident, near-miss, and hazard records in the system, safety trend analysis is impossible and corrective actions are not tracked to closure — meaning the organisation cannot demonstrate whether its safety programme is improving. \n\neffort: Achieving this requires capturing incident records with corrective actions and root cause investigations for significant incidents, and confirming that incident trends are reportable from structured data rather than from separate spreadsheets.",
      "respUnknown": "It's unclear whether safety incidents, near misses, and hazard reports are being captured in the system. Your Safety Officer or Operations Manager can confirm whether incident records exist, whether corrective actions are tracked, and whether incident trends are reportable."
    },
    {
      "id": "WE-1-DESK",
      ...
      "valueStatement": "Captures work history, technician wrench time, and failure details into Maximo, establishing the foundational digital record needed for maintenance analytics.",
      ...
      "signals": [
        "Work orders completed and closed in Maximo Manage via desktop/terminal",
      ...
      "prerequisiteType": null,
      "touchpoints": [
        "Maximo Manage — Desktop (Work Order Tracking)",
      ...
      "respMet": "Work order completion, labour actuals, and failure codes are entered digitally into Maximo via desktop or terminal data entry at shift completion. While data is not yet captured in real time at the asset, you have established the core digital work history that maintenance analytics and reporting build upon.",
      "respUnmet": "consequence: Without digital capture of work orders and actuals into Maximo, maintenance execution remains lost in paper or verbal channels — meaning labour hours, materials, and failure history cannot feed planning or analytics.\n\neffort: Achieving this requires establishing the operational discipline to record completed work orders, labour actuals (LABTRANS), and failure codes into Maximo Manage at the end of each shift.",
      "respUnknown": "It is unclear whether work order completions and actuals are being recorded digitally in Maximo via desktop terminals. Your Maintenance Supervisor or Planner can confirm whether technicians or clerks enter work order actuals at shift completion."
    },
    {
      "id": "WE-2-MOB",
      ...
      "valueStatement": "Eliminates paper lag, increases wrench time by reducing administrative trips, and ensures real-time accuracy of asset work history and failure codes.",
      ...
      "signals": [
        "Technicians access and update work orders on a mobile device (Maximo Mobile or equivalent)",
      ...
      "respMet": "Technicians receive and execute work orders digitally on mobile devices, updating statuses and logging actuals and failure codes in real time at the asset. This eliminates end-of-shift data entry lag and gives supervisors immediate operational visibility.",
      "respUnmet": "consequence: Without mobile work execution in the field, work history is captured with end-of-shift delay, wrench time is reduced by administrative travel, and real-time technician status is unavailable.\n\neffort: Achieving this requires deploying Maximo Mobile to field technicians, ensuring work order status transitions are performed at the point of work, and training staff to log actuals directly from devices.",
      "respUnknown": "It is unclear whether technicians are using mobile devices to receive and status work orders in the field. Your Field Technician or Maintenance Supervisor can confirm whether Maximo Mobile or an equivalent mobile tool is in active field use."
    },
    {
      "id": "WE-3-CONN",
      ...
      "signals": [
        "Offline-first architecture active: work order, asset, job plan, and domain data synced to device",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Mobile — Offline Technician App",
      ...
      "respMet": "Technicians operate with offline-first capability and full field data access — work, asset data, job plans, and parts lists are synced to the device and actuals write back automatically on reconnection. Execution quality and data capture are no longer dependent on network availability, and the field is a reliable source of real-time maintenance data.",
      "respUnmet": "consequence: Without offline capability and full field data access synced to the device, technicians are dependent on network connectivity to access work, asset data, and job plans — creating gaps in execution quality and actuals capture whenever connectivity is unavailable. \n\neffort: Achieving this requires activating offline-first architecture so work order, asset, job plan, and domain data are synced to the device, and ensuring materials issuance, meter readings, and inspection results all write back to the correct records on reconnection.",
      "respUnknown": "It's unclear whether technicians are operating with offline capability and full field data access. Your Field Technician or System Administrator can confirm whether offline sync is active, whether materials can be issued from the device, and whether inspection results write back to asset condition records."
    },
    {
      "id": "WE-4-MAPD",
      ...
      "signals": [
        "GPS location sharing active — dispatcher can see technician location in real time",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Mobile — Map & GPS Features",
      ...
      "respMet": "Technicians work from map-based views with GPS location sharing active, giving dispatchers real-time visibility and enabling routing, travel time recording, and field-identified work creation from map coordinates. Workforce utilisation can now be measured and improved from location data rather than estimated from phone calls and manual logs.",
      "respUnmet": "consequence: Without map-based work execution and GPS location sharing, dispatchers cannot see where technicians are in real time, routing to jobs is inefficient, and the travel time data needed to measure and improve workforce utilisation is not being captured. \n\neffort: Achieving this requires activating GPS location sharing so dispatchers have real-time technician visibility, displaying work orders on a map with proximity-based filtering, and enabling travel time recording against work orders.",
      "respUnknown": "It's unclear whether map-based work execution and GPS location sharing are in use. Your Field Technician or Dispatcher can confirm whether work orders are visible on a map, whether technician location is shared in real time, and whether travel time is being tracked."
    },
    {
      "id": "WE-5-BKIN",
      ...
      "signals": [
        "Emergency work orders pushed to technician device in real time",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Mobile — Real-Time Push Notifications",
      ...
      "respMet": "Emergency and break-in work is dynamically pushed to technicians in real time, with insertion logic driven by priority and criticality rather than manual dispatcher calls. Schedule disruption from urgent jobs is now managed by the system — dispatchers handle exceptions rather than manually rebuilding schedules when unplanned work arrives.",
      "respUnmet": "consequence: Without dynamic break-in work handling, emergency jobs are inserted into the schedule through manual phone calls and re-assignments — creating dispatcher overhead, disrupting existing schedules without system coordination, and leaving schedule adherence untrackable. \n\neffort: Achieving this requires real-time push of emergency work orders to the technician device, the ability for technicians to accept or request reassignment from the device, and break-in insertion logic driven by work order priority and criticality rather than manual dispatcher judgment.",
      "respUnknown": "It's unclear whether emergency and break-in work is being dynamically pushed to technicians without manual dispatcher phone calls. Your Field Technician or Dispatcher can confirm whether real-time push notifications are active and whether schedule disruption from break-in work is managed by the system."
    },
    {
      "id": "WE-5-MATL",
      ...
      "signals": [
        "Technicians view real-time bin balances and item availability from the mobile device",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Mobile 9.2 — Real-Time Bin Balances",
    ...
    },
    {
      ...
      "signals": [
        "Labor actuals used to update job plan duration estimates (estimated vs. actual visible and tracked)",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Manage — Work Order Actuals & LABTRANS",
    ...
    },
    {
      ...
      "signals": [
        "Push notifications from Maximo Predict or Health alerts initiate proactive work orders on device",
      ...
      "prerequisiteType": "Hard sequential",
      "touchpoints": [
        "Maximo Mobile — Predict Alert Integration",
      ...
      "respMet": "Condition-triggered work orders are visible to technicians in the field and predictive model outputs are actively influencing which jobs are prioritised for execution. The investment in predictive capability is now translating into changed maintenance behaviour — work is driven by where failure is heading, not by a calendar.",
      "respUnmet": "consequence: Without predictive alerts driving field work orders, technicians are executing work from calendar-based schedules rather than from evidence of where failure is actually heading — meaning the investment in predictive models does not yet translate into changed maintenance behaviour. \n\neffort: Achieving this requires condition-triggered work orders to be visible to technicians in the field, with predictive model outputs actively influencing which jobs are prioritised for execution over calendar-scheduled work.",
    ...
    },
    {
      ...
      "signals": [
        "Maximo Assistant or equivalent GenAI guidance active on the mobile device for at least one critical asset class",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "Maximo Assistant — In-Field GenAI Recommendations",
        "Maximo Health SPOG — AI Recommendation Cards",
        "Maximo Predict — GenAI Failure Interpretation",
      ...
      "respMet": "AI-driven prescriptive guidance is surfaced to technicians during work execution for critical asset classes, with outputs influencing maintenance decisions and resulting in recorded work order actions. Reliability expertise scales to every technician at the point of work — guidance is available when it is needed, not only when a specialist is reachable.",
      "respUnmet": "consequence: Without AI-guided recommendations active at the point of work, reliability expertise remains concentrated in a small number of engineers and cannot scale to every technician across the asset population. \n\neffort: Achieving this requires AI-driven prescriptive guidance to be surfaced to technicians during work execution for critical asset classes, with outputs influencing maintenance decisions and resulting in recorded work order actions.",
      "respUnknown": "It's unclear whether AI-guided recommendations are active at the point of work execution. Your Reliability Engineer or Operations Manager can confirm whether GenAI or prescriptive guidance is surfaced to technicians in the field and whether it is influencing maintenance decisions."
    },
    {
      "id": "AIP-#-##",
      ...
      "signals": [
        "Number of AIP capital plans active and linked to critical asset records in Maximo",
      ...
      "prerequisiteType": "Soft functional",
      "touchpoints": [
        "AIP — Capital Planning Scenarios & Replacement Analysis",
  ...
  "apmJourney": [
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "10–15%",
          "label": "increase in technician productivity via standardized job plans"
        },
        {
          "stat": "Accurate",
          "label": "asset hierarchy and criticality rankings across maintainable assets"
        },
        {
          "stat": "Standardized",
          "label": "failure code capture (Problem-Cause-Remedy) on 100% of closed work orders"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "15–20%",
          "label": "reduction in unplanned downtime for critical pilot assets"
        },
        {
          "stat": "Single",
          "label": "objective health score view across critical asset classes in Maximo Health"
        },
        {
          "stat": "Elimination",
          "label": "of calendar-only guesswork through lightweight condition telemetry"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "20–30%",
          "label": "reduction in unnecessary preventive maintenance labor and parts spend"
        },
        {
          "stat": "Real-time",
          "label": "OT/IoT telemetry ingestion in Maximo Monitor mapped to health factors"
        },
        {
          "stat": "Dynamic",
          "label": "PM frequency adjustments driven by asset condition and operating context"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "Up to 47%",
          "label": "reduction in unplanned downtime via early failure prediction"
        },
        {
          "stat": "10–20%",
          "label": "reduction in maintenance overtime and emergency repair costs"
        },
        {
          "stat": "Continuous",
          "label": "failure probability scoring and automated anomaly detection in Maximo Predict"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "10–15%",
          "label": "extension in asset economic lifespan through evidence-based lifecycle planning"
        },
        {
          "stat": "8–15%",
          "label": "optimization in MRO spare parts inventory holding costs"
        },
        {
          "stat": "Closed-loop",
          "label": "operational learning with GenAI prescriptive guidance at the point of work"
        }
      ],
      "products": [
        {
  ...
  "fsmJourney": [
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "Elimination",
          "label": "of lost or unassigned work orders through formal Assignment records"
        },
        {
          "stat": "Accurate",
          "label": "baseline capture of technician craft, shift, and calendar availability"
        },
        {
          "stat": "Baseline",
          "label": "tracking of work order scheduled start and finish targets"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "10–15%",
          "label": "reduction in administrative dispatch overhead and phone coordination"
        },
        {
          "stat": "8–12%",
          "label": "increase in wrench time through mobile work order delivery and status updates"
        },
        {
          "stat": "Multi-week",
          "label": "forward planning horizon actively managed in Assignment Manager"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "15–25%",
          "label": "reduction in technician travel time and return trips via proximity routing"
        },
        {
          "stat": "Significant",
          "label": "reduction in job delays caused by missing parts, permits, or tools"
        },
        {
          "stat": "Real-time",
          "label": "effective capacity calculation accounting for leaves and active assignments"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "≥80%",
          "label": "First-Time Fix Rate (FTFR) through automated skill- and parts-aware dispatch"
        },
        {
          "stat": "15–20%",
          "label": "reduction in emergency travel disruption via dynamic break-in scheduling"
        },
        {
          "stat": "Real-time",
          "label": "storeroom balance visibility and mobile material issuance from the field"
        }
      ],
      "products": [
        {
    ...
    },
    {
      ...
      "potentialOutcomes": [
        {
          "stat": "Up to 26%",
          "label": "overall technician productivity gain (achieving ≥45–55% wrench time)"
        },
        {
          "stat": "10–20%",
          "label": "reduction in overtime through autonomous schedule balancing"
        },
        {
          "stat": "Closed-loop",
          "label": "feedback from field actuals directly into job plan durations and inventory forecasts"
        }
      ],
      "products": [
        {
